var svgIconConfig = {
  ...
  navLeftArrow2 : {
	...
	rightArrow : {
		url : 'assets/svg/right-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
